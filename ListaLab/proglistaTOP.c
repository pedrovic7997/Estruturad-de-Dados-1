...
int main()
{
    ...
    TAluno* maria = InicializaTipoItem("maria", 123, "rua da maria");
    TAluno* sofia = InicializaTipoItem("sofia", 2345, "rua da sofia");
    TAluno* jose = InicializaTipoItem("jose", 4523, "rua do jose");
